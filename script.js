...
function processarDadosVendas(input) {
    const config = {
        tamanhosValidos: [
            ...
            "BATERIA EW", "BLACK SHEEP 20K", "BLVK 20", "BLVK 35", "BLVK 50",
            "CALIBURN A2", "CALIBURN A3", "CALIBURN G", "CALIBURN KOKO PRIME",
            "DICKBAR 10K", "ELF WORLD PE10K", "ELFBAR 10KBC", "ELFBAR 10KBC TOUCH",
            "ELFBAR 16K", "ELFBAR 18K", "ELFBAR 18K TOUCH", "ELFBAR 30KTE",
            "ELFBAR 5KTE", "ELFBAR EW 16K REFIL", "ELFBAR EW 9K", "ELFBAR EW 9K REFIL",
            "ELFBAR GH23K", "ELFBAR GOLDEN 10KBC", "ELFBAR ICE KING 40K",
            "ELFBAR NICOTINE PUNCH", "ELFLIQ SALT", "FREE", "HIIO BY MASKKING",
            "IGNITE CART P100", "IGNITE KIT P100", "JUICE MASKKING 2",
            "JUICE MASKKING 3.5", "JUICE MASKKING 5", "JUICE MR FREEZER", "JUICE NAKED",
            "JUUL", "KICK NICOTINE POUCHES", "LIFE POD ECO", "LIFE POD KIT",
            "LIFE POD REFIL 8K", "LIFE POD SK", "LOST MARY 16K", "MR FREEZE 0",
            "MR FREEZE 3", "OXBAR 10K PRO", "OXBAR 30K PRO", "OXBAR 8K", "OXBAR 9500",
